...
export const GamePlay: FunctionComponent<Props> = ({gameSettings}) => {
    ...
    const [hideKoreanKeyboardLayout, setHideKoreanKeyboardLayout] = useState(true);
            ...
            {gameState !== GameState.NOT_STARTED &&
                <div className="mt-12 sm:visible invisible">
                    <label className="inline-flex items-center cursor-pointer">
                        <input type="checkbox" value={hideKoreanKeyboardLayout ? "" : undefined}
                               className="sr-only peer"
                               onChange={() => setHideKoreanKeyboardLayout(!hideKoreanKeyboardLayout)}/>
                        <div
